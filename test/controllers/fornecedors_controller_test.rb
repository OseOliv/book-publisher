...
class FornecedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fornecedor" do
    assert_difference("Fornecedor.count") do
      post fornecedors_url, params: { fornecedor: { cnpj: @fornecedor.cnpj, conta: @fornecedor.conta, nome: @fornecedor.nome } }
    end
  ...
  test "should update fornecedor" do
    patch fornecedor_url(@fornecedor), params: { fornecedor: { cnpj: @fornecedor.cnpj, conta: @fornecedor.conta, nome: @fornecedor.nome } }
