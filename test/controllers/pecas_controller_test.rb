...
class PecasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create peca" do
    assert_difference("Peca.count") do
      post pecas_url, params: { peca: { fornecedor_id: @peca.fornecedor_id, nome: @peca.nome, valor: @peca.valor } }
    end
  ...
  test "should update peca" do
    patch peca_url(@peca), params: { peca: { fornecedor_id: @peca.fornecedor_id, nome: @peca.nome, valor: @peca.valor } }
